...
if(!get_post("class_module") == "install"){
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@
    include(dirname(__FILE__) . "/install_begin.php");
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@
}else{
		...
		//         $result_query = &$cmr->db_connection->query("CREATE DATABASE IF NOT EXISTS " . $db_name . ";") /*, $db_con)*/ or $install_prints .= ("<h3>!!! " . $cmr->db_connection->ErrorMsg() . " !!!? </h3>");
		...
		/*=================================================================*/
		/*=================================================================*/
		    include(dirname(__FILE__) . "/install_end.php");
		/*=================================================================*/
