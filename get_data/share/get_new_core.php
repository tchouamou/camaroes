...
$cmr->query[0] = "insert into " . $cmr->get_conf("cmr_table_prefix") . $table_name . "  ( £_foreach_column_£ @_column_@, ££_foreach_column_££ ) values (£_foreach_column_£  '$post->@_column_@', ££_foreach_column_££ );";
*/
...
$cmr->notify = $cmr->load_notify($templates_notify, $table_name, "new");
// $cmr->notify = db_load_notify($cmr->config, $cmr->user, $cmr->db_connection, $cmr->config["cmr_table_prefix"] . $table_name, "new", $cmr->page["language"]);
/*
Creating the appropriate Message to be view for confirmation 
*/
$cmr->output[0] = "<p><b>" . $cmr->translate($table_name) . "  " . $cmr->translate("update_success") . "</b>";
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$cmr->log_to_db("'" . $cmr->get_user("auth_email") . "', '" . $cmr->get_conf("cmr_table_prefix") . $table_name . "', 'new', '" . $cmr->notify["to_log"] . "'");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$cmr->email["subject"] = $cmr->get_conf("cmr_company_name3") . ":  ".$cmr->translate("new") . $cmr->translate("  " . $table_name);
$cmr->email["message"] = $cmr->translate("was create") . $cmr->translate("  " . $table_name . " by : ") . $cmr->get_user("auth_email") . "\n\n\n";
