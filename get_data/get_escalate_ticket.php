...
get_escalate_ticket.php,  2011-Oct
*/
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// case "escalate_ticket"://all var send by link------------
$id = get_post("id_ticket");
$number = get_post("number");
$assign_to = get_post("assign_to");
// -----------------------------------------------------
$cmr->post_var["id_ticket"] = $id; // for escalate ticket
// -----------------------------------------------------
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$cmr->log_to_db("'" . $cmr->get_user("auth_email") . "', '" . $cmr->get_conf("cmr_table_prefix") . "ticket', '" . cmr_escape($id) . "' ,'escalate'");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
