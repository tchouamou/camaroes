...
if(!(class_exists("@_table_@_class"))){
    class @_table_@_class{
         ...
         * @var string
         **/
        var $cmr_table = "@_table_@";
        /**
         *
         * @var string
         **/
        var $cmr_order = "@_column_id_@";
        /**
         *
         * @var Int
         **/
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "@_table_@ WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "@_table_@ WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        function query_update($col_id = "")
        {
			...
			$array_id["key"] = "@_column_id_@";
			$array_id["value"] = $this->@_column_id_@;
