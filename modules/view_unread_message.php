...
view_unread_message.php,Ver 3.0  2011-Aug-Wed 06:24:27  
*/
...
$cmr->query[$cmr->action["table_name"]] = $qr->get_query("unread_message");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// $message_readed = cmr_readed_line($cmr->config, $cmr->user, $cmr->db_connection, "message");
// $list_id_message=implode($message_readed, "','");
// // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// $cmr->query[$cmr->action["table_name"]] .= " AND id NOT IN ('" . $list_id_message . "')";
...
if(file_exists($view_message_file)) include($view_message_file);
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
