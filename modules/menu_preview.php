...
menu_preview,Ver 3.0  @_date_time_@
*/
...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^preview_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/".$file)){
...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^preview_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/auto/" . $file)){
