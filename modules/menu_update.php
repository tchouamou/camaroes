...
menu_update,Ver 3.0  @_date_time_@  
*/
...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^new_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/".$file)){
...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^new_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/auto/" . $file)){
