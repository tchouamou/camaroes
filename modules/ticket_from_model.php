...
ticket_from_model.php,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$cmr->action["todo"] = "ticket_from_model";

include($cmr->get_path("module") . "modules/ticket.php");

@ cmrdb_free_result($cmr->db["result"]["t_model_solution"]);
$result_te->Close();
$result_number->Close();
$result_rif->Close();
$result_group->Close();
...
cmrdb_free_result($result_ticket);
$result_model->Close();
