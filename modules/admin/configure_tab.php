...
configure_tab.php,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$dir = opendir($cmr->get_path("tab") . "page/");
...
while ($file = readdir($dir)){
    $file_name = $cmr->get_path("tab") . "page/" . $file;
    if(($file != ".") && ($file != "..") && (is_dir($file))){
        print("<li>" . $cmr->module_link($cmr->get_path("module") . "modules/load_configure.php?file_name=" . $file_name . "/" . $cmr->get_conf("cmr_page_filename"), "", $file) . "</li>");
    };
    print("</ul>");
}
