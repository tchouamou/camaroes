...
// $lk->add_link("modules/form_generator.php?conf_name=conf.d/modules/conf_form_generator.ini", 1);;
// $lk->add_link("modules/form_generator.php?conf_name=conf.d/modules/conf_form_generator.ini&&conf_name=conf.d/modules/conf_form_generator.ini", 1);
...
// $lk->add_link("modules/site_map.php?conf_name=conf.d/modules/conf_site_map.ini", 1);;
...
<?php print(input_hidden("<input type=\"hidden\" value=\"get_data/get_query.php\" name=\"cmr_get_data\" />"));?>
