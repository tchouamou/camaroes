...
configure_lang.php,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$dir = opendir($cmr->get_path("lang") . "languages/");

print("<fieldset class=\"bubble\"><legend>" . $cmr->translate("language") . "</legend>");
echo "<ul style=\"text-align:left;\" >";
$cols++;

while ($file = readdir($dir)){
    $file_name = $cmr->get_path("lang") . "languages/" . $file;
    if(($file != ".") && ($file != "..") && (is_dir($file_name))){
        print("<li>" . $cmr->module_link($cmr->get_path("module") . "modules/load_configure.php?file_name=" . $file_name . "/" . $cmr->get_conf("cmr_lang_filename"), "", "<h2>" . $file . "</h2>") . "</li>");
        // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        // @@@@@@@@@@@@@@@@ Reading the sub folder @@@@@@@@@@@@@@@@@@
        // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
         print("<fieldset class=\"bubble\"><legend>" . $cmr->translate($file) . "</legend>");
        ...
        while ($file1 = readdir($dir1)){
            $file_name1 = $cmr->get_path("lang") . "languages/" . $file . "/" . $file1 . "/" ;
		    if(($file1 != ".") && ($file1 != "..") && ($file1 != ".htaccess") && ($file1 != "index.html") && ($file1) && (is_file($file_name1))){
