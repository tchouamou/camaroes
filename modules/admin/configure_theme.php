...
configure_theme.php,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$dir = opendir($cmr->get_path("theme") . "themes/");
...
while ($file = readdir($dir)){
    $file_name = $cmr->get_path("theme") . "themes/" . $file;
    if(($file != ".") && ($file != "..") && (is_dir($file_name))){
        print("<li>" . $cmr->module_link($cmr->get_path("module") . "modules/load_configure.php?file_name=" . $file_name . "/" . $cmr->get_conf("cmr_theme_filename"), "", $file) . "</li>");
    };
    print("</ul>");
}
