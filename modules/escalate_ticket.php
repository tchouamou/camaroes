...
// $division->module["title"] = "escalate_ticket";
...
$lk->add_link("modules/escalate_ticket.php?conf_name=conf.d/modules/conf_escalate_ticket.ini&id_ticket=" . $id . "&refresh=", 1);;
...
<?php print(input_hidden("<input type=\"hidden\" value=\"get_data/get_escalate_ticket.php\" name=\"cmr_get_data\" />"));?>
...
<input class="submit" id="submit2" type="button" <?php print("value=\"" . $cmr->translate("escalate_ticket") . "\"");
