...
All rights reserved.
search_services.php, Ver 3.0, 2010-Sep-Mon 11:08:34  
*/
...
$table_name = "services";
$array_column = array();
$cmr->config["cmr_default_table"] = "services";
$cmr->page["default_search"] = "services";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['my_slave']['name'] = 'my_slave';
$array_column['my_slave']['type'] = 'varchar';
$array_column['my_slave']['foreign'] = '1';
