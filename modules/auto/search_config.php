...
All rights reserved.
search_config.php, Ver 3.0, 2010-Sep-Mon 11:01:10  
*/
...
$table_name = "config";
$array_column = array();
$cmr->config["cmr_default_table"] = "config";
$cmr->page["default_search"] = "config";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['the_key']['name'] = 'the_key';
$array_column['the_key']['type'] = 'varchar';
$array_column['the_key']['foreign'] = '0';

$array_column['value']['name'] = 'value';
$array_column['value']['type'] = 'varchar';
$array_column['value']['foreign'] = '0';
