...
All rights reserved.
search_va.php, Ver 3.0, 2010-Sep-Mon 11:12:46  
*/
...
$table_name = "va";
$array_column = array();
$cmr->config["cmr_default_table"] = "va";
$cmr->page["default_search"] = "va";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['va_ip']['name'] = 'va_ip';
$array_column['va_ip']['type'] = 'text';
$array_column['va_ip']['foreign'] = '0';
