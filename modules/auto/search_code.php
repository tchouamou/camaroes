...
All rights reserved.
search_code.php, Ver 3.0, 2010-Sep-Mon 10:59:57  
*/
...
$table_name = "code";
$array_column = array();
$cmr->config["cmr_default_table"] = "code";
$cmr->page["default_search"] = "code";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['script']['name'] = 'script';
$array_column['script']['type'] = 'text';
$array_column['script']['foreign'] = '0';
