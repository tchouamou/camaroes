...
All rights reserved.
search_translate.php, Ver 3.0, 2010-Sep-Mon 11:11:32  
*/
...
$array_column = array();
$cmr->config["cmr_default_table"] = "translate";
$cmr->page["default_search"] = "translate";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['code']['name'] = 'code';
$array_column['code']['type'] = 'varchar';
$array_column['code']['foreign'] = '0';
...
$array_column['translate_language']['name'] = 'translate_language';
$array_column['translate_language']['type'] = 'varchar';
$array_column['translate_language']['foreign'] = '0';

$array_column['translate_text']['name'] = 'translate_text';
$array_column['translate_text']['type'] = 'text';
$array_column['translate_text']['foreign'] = '0';
