...
All rights reserved.
search_command.php, Ver 3.0, 2010-Sep-Mon 11:00:22  
*/
...
$table_name = "command";
$array_column = array();
$cmr->config["cmr_default_table"] = "command";
$cmr->page["default_search"] = "command";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['command_name']['name'] = 'command_name';
$array_column['command_name']['type'] = 'varchar';
$array_column['command_name']['foreign'] = '0';

$array_column['command_line']['name'] = 'command_line';
$array_column['command_line']['type'] = 'varchar';
$array_column['command_line']['foreign'] = '0';
