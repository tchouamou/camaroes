...
All rights reserved.
search_cron.php, Ver 3.0, 2010-Sep-Mon 11:01:57  
*/
...
$table_name = "cron";
$array_column = array();
$cmr->config["cmr_default_table"] = "cron";
$cmr->page["default_search"] = "cron";
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$array_column['command']['name'] = 'command';
$array_column['command']['type'] = 'varchar';
$array_column['command']['foreign'] = '1';

$array_column['at']['name'] = 'at';
$array_column['at']['type'] = 'timestamp';
$array_column['at']['foreign'] = '0';
