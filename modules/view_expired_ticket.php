...
view_expired_ticket.php,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$cmr->action[$cmr->action["table_name"] . "_title"] = $cmr->translate("Expired of " . $cmr->action["table_name"]);
$cmr->action[$cmr->action["table_name"] . "_title1"] = $cmr->translate("List Expired of " . $cmr->action["table_name"]);;
...
$cmr->query[$cmr->action["table_name"]] = $qr->get_query("expired_ticket");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// $cmr->query[$cmr->action["table_name"]] .= " AND (  CURRENT_TIMESTAMP + 0 > sla + 0) ";
