...
my_groups.php,Ver 3.0  2011-Sep 22:32:40  
*/
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$file_list = array();
$file_list[] = $cmr->get_path("module") . "modules/admin/update_groups.php";
$file_list[] = $cmr->get_path("module") . "modules/update_groups.php";
$file_list[] = $cmr->get_path("module") . "modules/auto/update_groups.php";
