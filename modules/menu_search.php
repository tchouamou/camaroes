...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^search_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/".$file)){
...
// ====================================================
    ...
    while ($file = readdir($dir)){
        if(($file != ".") && cmr_search("^search_", $file) && ($file != "..") && is_file($cmr->get_path("module") . "modules/auto/" . $file)){
