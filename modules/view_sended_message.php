...
view_sended_message.php,Ver 3.0  2011-Aug-Wed 06:24:27  
*/
...
$cmr->action[$cmr->action["table_name"] . "_title"] = $cmr->translate("Sended " . $cmr->action["table_name"]);
$cmr->action[$cmr->action["table_name"] . "_title1"] = $cmr->translate("List sended " . $cmr->action["table_name"]);;
...
$cmr->query[$cmr->action["table_name"]] = $qr->get_query("sended_message");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// $cmr->query[$cmr->action["table_name"]] .="  (sender like ('%" . $email . "%')) ";
