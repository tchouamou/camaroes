...
if($cmr->post_var["cmr_get_data"] == "modules/database/get_data/get_import_table.php"){
...
$division->prints["match_form_id"] = "import_form";

$division->prints["match_input_hidden_get"] = input_hidden("<input type=\"hidden\" value=\"modules/database/get_data/get_import_table.php\" name=\"cmr_get_data\" />");
...
$division->prints["match_label_import_to"] = $cmr->translate("import to table");
$division->prints["match_label_type"] = $cmr->translate("Type:");
$division->prints["match_select_type"] = cmrprint_select($cmr->get_conf("cmr_import_type"), "import_type", "");
$division->prints["match_label_action"] = $cmr->translate("Action:");
$division->prints["match_select_action"] = cmrprint_select($cmr->get_conf("cmr_import_action"), "import_action", "");
$division->prints["match_label_file"] = $cmr->translate("File to import");
$division->prints["match_label_text_import"] = $cmr->translate("Text to import");
$division->prints["match_label_fields_terminated"] = $cmr->translate("FIELDS TERMINATED BY:");
$division->prints["match_label_optionally_enclosed"] = $cmr->translate("OPTIONALLY ENCLOSED BY:");
$division->prints["match_label_lines_starting"] = $cmr->translate("LINES STARTING BY:");
$division->prints["match_label_lines_terminated"] = $cmr->translate("LINES TERMINATED BY:");
$division->prints["match_label_fields_escaped"] = $cmr->translate("FIELDS ESCAPED BY:");
$division->prints["match_label_ignore"] = $cmr->translate("IGNORE NUMBER LINES:");
...
$division->prints["match_submit_java"] = $cmr->translate("confirm that you want to import in");
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$file_list = array();
$file_list[] = $cmr->get_user("auth_user_path") . "templates/modules/template_import_table" . $cmr->get_ext("template");
$file_list[] = $cmr->get_user("auth_group_path") . "templates/modules/template_import_table" . $cmr->get_ext("template");
$file_list[] = $cmr->get_path("module") . "modules/database/templates/template_import_table" . $cmr->get_ext("template");
// $file_list[] = $cmr->get_path("template") . "templates/modules/auto/template_import_table" . $cmr->get_ext("template");
