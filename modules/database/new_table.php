...
$division->prints["match_input_hidden_id_table"] = "";
$division->prints["match_submit_update"] = "";
$division->prints["match_submit_java1"] = "";
$division->prints["match_submit_new"] = "";
$division->prints["match_submit_java2"] = "";
...
foreach($array_columns as $key => $value){
  ...
  $division->prints["match_update_column"] .= cmrprint_select($cmr->get_conf("cmr_new_function"), "func_$value", "");
  $division->prints["match_update_column"] .= "</td><td class=\"normal_text\" align=\"left\">";
if(empty($all_columns[1][$value]))$all_columns[1][$value] = "";
  $division->prints["match_update_column"] .= print_column($all_columns[1][$value], $value, "", $table_name);
//   $division->prints["match_update_column"] .= "<input size=\"20\" type=\"text\" value=\"\"  id=\"" . $value . "\" name=\"" . $value . "\" onclick=\"large_id('" . $mod->base_name . "," . $value . "')\">";
