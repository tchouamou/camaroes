...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$division->prints["match_show_graph_line"] = "";
$division->prints["match_show_graph_barcode"] = "";

$division->prints["match_show_graph_legend"] = "";
$division->prints["match_show_graph_bar"] = "";
$division->prints["match_show_graph_pie"] = "";

$division->prints["match_show_graph_legend1"] = "";
$division->prints["match_show_graph_bar1"] = "";
$division->prints["match_show_graph_pie1"] = "";

$division->prints["match_show_graph_legend2"] = "";
$division->prints["match_show_graph_bar2"] = "";
$division->prints["match_show_graph_pie2"] = "";

$division->prints["match_show_graph_legend3"] = "";
$division->prints["match_show_graph_bar3"] = "";
$division->prints["match_show_graph_pie3"] = "";

$division->prints["match_show_graph_legend4"] = "";
$division->prints["match_show_graph_bar4"] = "";
$division->prints["match_show_graph_pie4"] = "";

$division->prints["match_show_graph_legend5"] = "";
$division->prints["match_show_graph_bar5"] = "";
$division->prints["match_show_graph_pie5"] = "";
	//======================================================================
	//======================================================================
	//======================================================================
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	//==============
	$cmr->query["report_default"] = "SELECT *  FROM  " . $cmr->post_var["current_database"] . "." . $cmr->post_var["report_table"] . " procedure analyse()";
	$data = sql_run("array", $database_conn, "query", $cmr->query["report_default"], $cmr->post_var["current_database"]);
	//==============

	//==============
	
	if(!function_exists("my_ereg_replace")){
	function my_cmr_search_replace($item1, $item2){
...
// 	$g->ydata2=implode($data[7], ",");
	...
	if(!empty($data[0])) $a = array_fill(0, count($data[0]), $cmr->post_var["current_database"] . "." . $cmr->post_var["report_table"] . ".");
  ...
  $division->prints["match_show_graph_legend1"] = $cmr->translate("Min length ");
	
  $division->prints["match_show_data1"] = ($g->show_data());
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar1"] = ($g->show_graph(microtime()));

	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie1"] = ($g->show_graph(microtime()));
	//==============
  ...
  $division->prints["match_show_graph_legend2"] = $cmr->translate("Max length");
	
  $division->prints["match_show_data2"] = ($g->show_data());
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar2"] = ($g->show_graph(microtime()));

	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie2"] = ($g->show_graph(microtime()));
	//==============
  ...
  $division->prints["match_show_graph_legend3"] = $cmr->translate("Empties or zeros");
	
  $division->prints["match_show_data3"] = ($g->show_data());
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar3"] = ($g->show_graph(microtime()));

	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie3"] = ($g->show_graph(microtime()));
	//==============
  ...
  $division->prints["match_show_graph_legend4"] = $cmr->translate("Nulls");
	
  $division->prints["match_show_data4"] = ($g->show_data());
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar4"] = ($g->show_graph(microtime()));

	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie4"] = ($g->show_graph(microtime()));
	//==============
  ...
  $division->prints["match_show_graph_legend5"] = $cmr->translate("Avg value or avg length");
	
  $division->prints["match_show_data5"] = ($g->show_data());
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar5"] = ($g->show_graph(microtime()));

	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie5"] = ($g->show_graph(microtime()));
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
$data1 = sql_run("", $database_conn, "query", $cmr->query["report"], $cmr->post_var["current_database"]);
// $data2= sql_run("", $database_conn, "query", $cmr->query["report"], $cmr->post_var["current_database"]);
$ydata1 = array("0");
$xlabel1 = array("0");
...
// 	$value["select_period"];
  ...
  $division->prints["match_show_data"] = ($g->show_data());
	
  $division->prints["match_show_graph_legend"] = strtoupper($cmr->translate($cmr->post_var["report_table"] . " / " . $key));

	if(!empty($value["show_graph"])){
	if($value["type1"]=="default"){
		
	$g->type1 = "bar";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_bar"] = $cmr->translate("version [bar graph]");
  $division->prints["match_show_graph_bar"] .= ($g->show_graph(microtime()));
	
	$g->type1 = "pie";//'bar','line','pie','barcode'..
  $division->prints["match_show_graph_pie"] = $cmr->translate("version [pie graph]");
  $division->prints["match_show_graph_pie"] .= ($g->show_graph(microtime()));
	}else{
  $division->prints["match_show_graph_pie"] .= ($g->show_graph(microtime()));
	}
	}
