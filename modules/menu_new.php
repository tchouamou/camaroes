...
// ====================================================
    foreach ($array_modules["path"] as $key => $value){
		...
		print("<li class=\"menu_row".($key % 2)."\" height=\"20\" onmouseover=\"this.style.backgroundcolor='#00eeee'\" onmouseout=\"this.style.backgroundcolor=''\">");
