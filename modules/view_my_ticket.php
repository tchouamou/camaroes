...
view_my_ticket,Ver 3.0  2011-Sep-Wed 12:32:30  
*/
...
$cmr->query[$cmr->action["table_name"]] = $qr->get_query("my_ticket");
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// $cmr->query[$cmr->action["table_name"]] .= " WHERE (((assign_to='" . $cmr->get_user("auth_email") . "') ";
// $cmr->query[$cmr->action["table_name"]] .= " OR (call_log_user='" . $cmr->get_user("auth_email") . "')  OR (work_by='" . $cmr->get_user("auth_email") . "')) ";
// $cmr->query[$cmr->action["table_name"]] .= " AND (my_master != 'cmr_model') ";
// $cmr->query[$cmr->action["table_name"]] .= " AND (state_now=state)  ";
