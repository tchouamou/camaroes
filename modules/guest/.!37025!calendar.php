...
<?php
// open_box($cmr->config, $cmr->language, $cmr->module["name"], $cmr->module["rown_position"], $cmr->module["col_position"], "<img alt=\"=> \" src=\"".$cmr->get_path("image") ."images/icon/pallino_blue.gif\">"." Calendar");
