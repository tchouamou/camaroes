...
menu_left.php,Ver 3.0  2011-Sep 22:32:40  
*/
...
foreach($module as $key => $value){
    if(!empty($value)){
        ...
        if(file_exists($image)) print("<img src=\"" . $cmr->config["cmr_www_path"] . $image . "\" alt=\"|\" />");
        if(!file_exists($image)) print($cmr->module_icon($mod_name, "16"));           
