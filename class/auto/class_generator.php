...
class_generator.php, Ver 3.03, 2011-Apr-Thu 23:21:44
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["generator_read"] = $cmr->readed_line("generator");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("generator_class"))){
	...
	{
	   return $this->generator_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function generator_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['db'] = $this->db : $this->cmr_array_column['db'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['table_name'] = $this->table_name : $this->cmr_array_column['table_name'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['column'] = $this->column : $this->cmr_array_column['column'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['code1'] = $this->code1 : $this->cmr_array_column['code1'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['code2'] = $this->code2 : $this->cmr_array_column['code2'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['code3'] = $this->code3 : $this->cmr_array_column['code3'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->db = '';
            if(get_post('db')) $this->db = get_post('db', $action, $pre_match);
            
            $this->table_name = '';
            if(get_post('table_name')) $this->table_name = get_post('table_name', $action, $pre_match);
            
            $this->column = '';
            if(get_post('column')) $this->column = get_post('column', $action, $pre_match);
            
            $this->code1 = '';
            if(get_post('code1')) $this->code1 = get_post('code1', $action, $pre_match);
            
            $this->code2 = '';
            if(get_post('code2')) $this->code2 = get_post('code2', $action, $pre_match);
            
            $this->code3 = '';
            if(get_post('code3')) $this->code3 = get_post('code3', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "generator WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "generator WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "generator field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "generator into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "generator WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "generator WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
