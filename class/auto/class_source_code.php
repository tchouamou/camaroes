...
class_source_code.php, Ver 3.03, 2011-Apr-Thu 23:21:47
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["source_code_read"] = $cmr->readed_line("source_code");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("source_code_class"))){
	...
	{
	   return $this->source_code_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function source_code_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['path'] = $this->path : $this->cmr_array_column['path'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['language'] = $this->language : $this->cmr_array_column['language'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['lang_version'] = $this->lang_version : $this->cmr_array_column['lang_version'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['code_version'] = $this->code_version : $this->cmr_array_column['code_version'] = $value;
            ...
            (empty($value)) ? $this->cmr_array_column['author'] = $this->author : $this->cmr_array_column['author'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['copyright'] = $this->copyright : $this->cmr_array_column['copyright'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['my_md5'] = $this->my_md5 : $this->cmr_array_column['my_md5'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['license'] = $this->license : $this->cmr_array_column['license'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->path = '';
            if(get_post('path')) $this->path = get_post('path', $action, $pre_match);
            
            $this->language = '';
            if(get_post('language')) $this->language = get_post('language', $action, $pre_match);
            
            $this->lang_version = '';
            if(get_post('lang_version')) $this->lang_version = get_post('lang_version', $action, $pre_match);
            
            $this->code_version = '';
            if(get_post('code_version')) $this->code_version = get_post('code_version', $action, $pre_match);
            ...
            $this->author = '';
            if(get_post('author')) $this->author = get_post('author', $action, $pre_match);
            
            $this->copyright = '';
            if(get_post('copyright')) $this->copyright = get_post('copyright', $action, $pre_match);
            
            $this->my_md5 = '';
            if(get_post('my_md5')) $this->my_md5 = get_post('my_md5', $action, $pre_match);
            
            $this->license = '';
            if(get_post('license')) $this->license = get_post('license', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "source_code WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "source_code WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "source_code field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "source_code into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "source_code WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "source_code WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
