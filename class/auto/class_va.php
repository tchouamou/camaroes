...
class_va.php, Ver 3.03, 2011-Apr-Thu 23:21:48
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["va_read"] = $cmr->readed_line("va");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("va_class"))){
    class va_class{
	...
	{
	   return $this->va_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function va_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['va_ip'] = $this->va_ip : $this->cmr_array_column['va_ip'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->va_ip = '';
            if(get_post('va_ip')) $this->va_ip = get_post('va_ip', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "va WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "va WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "va field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "va into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "va WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "va WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
