...
class_forum.php, Ver 3.03, 2011-Apr-Thu 23:21:43
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["forum_read"] = $cmr->readed_line("forum");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("forum_class"))){
    class forum_class{
	...
	{
	   return $this->forum_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function forum_class($cmr_config = array(), $cmr_user = array())
        {
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "forum WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "forum WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "forum field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "forum into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "forum WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "forum WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
