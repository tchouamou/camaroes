...
class_father_groups.php, Ver 3.03, 2011-Apr-Thu 23:21:43
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["father_groups_read"] = $cmr->readed_line("father_groups");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("father_groups_class"))){
    class father_groups_class{
	...
	{
	   return $this->father_groups_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function father_groups_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['group_father'] = $this->group_father : $this->cmr_array_column['group_father'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['group_child'] = $this->group_child : $this->cmr_array_column['group_child'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->group_father = '';
            if(get_post('group_father')) $this->group_father = get_post('group_father', $action, $pre_match);
            
            $this->group_child = '';
            if(get_post('group_child')) $this->group_child = get_post('group_child', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "father_groups WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
         ...
         * @param int $limit
         * @return array $father_groupsList
         **/
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "father_groups WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "father_groups field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "father_groups into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "father_groups WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "father_groups WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
