...
class_user_groups.php, Ver 3.03, 2011-Apr-Thu 23:21:48
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["user_groups_read"] = $cmr->readed_line("user_groups");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("user_groups_class"))){
    class user_groups_class{
	...
	{
	   return $this->user_groups_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function user_groups_class($cmr_config = array(), $cmr_user = array())
        {
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "user_groups WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "user_groups WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "user_groups field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "user_groups into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "user_groups WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "user_groups WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
