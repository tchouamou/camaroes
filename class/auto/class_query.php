...
class_query.php, Ver 3.03, 2011-Apr-Thu 23:21:46
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["query_read"] = $cmr->readed_line("query");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("query_class"))){
	...
	{
	   return $this->query_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function query_class($cmr_config = array(), $cmr_user = array())
        {
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "query WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "query WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "query field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "query into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "query WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "query WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
