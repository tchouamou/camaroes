...
class_contact.php, Ver 3.03, 2011-Apr-Thu 23:21:42
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["contact_read"] = $cmr->readed_line("contact");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("contact_class"))){
    class contact_class{
	...
	{
	   return $this->contact_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function contact_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['functio'] = $this->functio : $this->cmr_array_column['functio'] = $value;
            ...
            (empty($value)) ? $this->cmr_array_column['country'] = $this->country : $this->cmr_array_column['country'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->functio = '';
            if(get_post('functio')) $this->functio = get_post('functio', $action, $pre_match);
            ...
            $this->country = '';
            if(get_post('country')) $this->country = get_post('country', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "contact WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "contact WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "contact field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "contact into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "contact WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "contact WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
