...
class_translate.php, Ver 3.03, 2011-Apr-Thu 23:21:48
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["translate_read"] = $cmr->readed_line("translate");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("translate_class"))){
	...
	{
	   return $this->translate_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function translate_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['code'] = $this->code : $this->cmr_array_column['code'] = $value;
            ...
            (empty($value)) ? $this->cmr_array_column['translate_language'] = $this->translate_language : $this->cmr_array_column['translate_language'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['translate_text'] = $this->translate_text : $this->cmr_array_column['translate_text'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->code = '';
            if(get_post('code')) $this->code = get_post('code', $action, $pre_match);
            ...
            if(get_post('translate_language')) $this->translate_language = get_post('translate_language', $action, $pre_match);
            
            $this->translate_text = '';
            if(get_post('translate_text')) $this->translate_text = get_post('translate_text', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "translate WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "translate WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "translate field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "translate into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "translate WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "translate WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
