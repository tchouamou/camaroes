...
class_policy.php, Ver 3.03, 2011-Apr-Thu 23:21:45
*/
...
// ==============================================        
    // ==========
    // ==========
    $GLOBALS["policy_read"] = $cmr->readed_line("policy");
    // ==========
    // ==========
// ==============================================        
if(!(class_exists("policy_class"))){
	...
	{
	   return $this->policy_class($cmr_config, $cmr_user);
	}
    //00000000000000000000000000 
        function policy_class($cmr_config = array(), $cmr_user = array())
        {
        ...
        function get_array_datas($value = "")
        {
            ...
            (empty($value)) ? $this->cmr_array_column['table_name'] = $this->table_name : $this->cmr_array_column['table_name'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['line_id'] = $this->line_id : $this->cmr_array_column['line_id'] = $value;
            ...
            (empty($value)) ? $this->cmr_array_column['privilege'] = $this->privilege : $this->cmr_array_column['privilege'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['allow_type'] = $this->allow_type : $this->cmr_array_column['allow_type'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['allow_email'] = $this->allow_email : $this->cmr_array_column['allow_email'] = $value;
            
            (empty($value)) ? $this->cmr_array_column['allow_groups'] = $this->allow_groups : $this->cmr_array_column['allow_groups'] = $value;
        ...
        function get_form_datas($action = "post", $pre_match = "")
        {
            ...
            $this->table_name = '';
            if(get_post('table_name')) $this->table_name = get_post('table_name', $action, $pre_match);
            
            $this->line_id = '';
            if(get_post('line_id')) $this->line_id = get_post('line_id', $action, $pre_match);
            ...
            $this->privilege = '';
            if(get_post('privilege')) $this->privilege = get_post('privilege', $action, $pre_match);
            
            $this->allow_type = '';
            if(get_post('allow_type')) $this->allow_type = get_post('allow_type', $action, $pre_match);
            
            $this->allow_email = '';
            if(get_post('allow_email')) $this->allow_email = get_post('allow_email', $action, $pre_match);
            
            $this->allow_groups = '';
            if(get_post('allow_groups')) $this->allow_groups = get_post('allow_groups', $action, $pre_match);
...
//          $this->cmr_query["select"] = "SELECT * FROM " . $this->cmr_prefix . "policy WHERE " . $this->accept("select") . " and " . $where;//." LIMIT ".$this->cmr_limit;
...
//          $this->cmr_query["view"] = "SELECT * FROM " . $this->cmr_prefix . "policy WHERE " . $this->accept("select") . "";
...
//          $this->cmr_query["import"] = "LAOD DATA LOCAL INFILE " . $file_name . " into table " . $this->cmr_prefix . "policy field terminate by '\\\n';";
...
//          $this->cmr_query["export"] = "SELECT * FROM " . $this->cmr_prefix . "policy into outfile " . $file_name . " field terminate by '\\\n'";
...
//          $this->cmr_query["report"] = "SELECT COUNT * FROM " . $this->cmr_prefix . "policy WHERE " . $this->accept("select") . " and " . $where; //." LIMIT " . $this->cmr_limit;
        ...
        {
// 		$this->cmr_query["delete"]  = "DELETE FROM " . $this->cmr_prefix . "policy WHERE " . $this->accept("delete");
// 		
// 		$list_id = "";
// 		if(is_array($val_id)){
